                    ...
                    woofysForSaleByOthers.map((woofyForSaleByOthers) => (
                        <Box key={woofyForSaleByOthers.tokenId.toString()} width="full" position="relative">
                            <Tooltip label="Price this WOOFY is selling for; non-negotiable." placement="top">
                                <Text position="absolute" top="6" right="6" fontSize="lg" userSelect="none" color="black">{ethers.utils.formatEther(woofyForSaleByOthers.price)} BNB</Text>
                            </Tooltip>
            ...
            <AlertDialog isOpen={dialogVisible} onClose={handleCloseDialog} leastDestructiveRef={cancelButtonRef} isCentered>
                <AlertDialogOverlay>
                    <AlertDialogContent>
                        ...
                        <AlertDialogBody>
                            {!!woofySelected &&
                                <Text>Purchase this WOOFY for {ethers.utils.formatEther(woofySelected?.price as BigNumber)} BNB ?</Text>
                            }
                        </AlertDialogBody>
