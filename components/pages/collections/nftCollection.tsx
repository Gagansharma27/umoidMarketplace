                    ...
                    return (
                        <GridItem key={nft.tokenId.toString()} as="figure" width="full" wordBreak="break-word" display="flex" flexDirection="column">
                            ...
                            <Text width="full" padding="2" textAlign="center" backgroundColor={nftStatus === NftStatus.NOT_OWN_NOT_FOR_SALE ? "gray.500" : (nftStatus === NftStatus.OWN_FOR_SALE ? "green.500" : "blue.400")} color="white">
                                ...
                                {(nftStatus === NftStatus.OWN_FOR_SALE || nftStatus === NftStatus.NOT_OWN_FOR_SALE) && ` - ${ethers.utils.formatEther(nft.tokenPrice)} BNB`}
                            </Text>
                        </GridItem>
                    )
                })}
                    ...
                    <AlertDialogContent>
                        ...
                        <AlertDialogBody>
                            ...
                            <FormControl isRequired>
                                ...
                                <Input min="0" focusBorderColor="brand.500" value={nftForSaleAmount} onChange={(e) => { setNftForSaleAmount(e.target.value) }} type="number" placeholder="XX.XX (BNB)" />
                                <FormHelperText>Current marketplace commission: {3 - (numOfWoofysOwned.toNumber() * 0.05)}%</FormHelperText>
                                <Link passHref href="/dexcoin"><a>
                                    <Text marginTop="2" fontStyle="italic" fontWeight="600" fontSize="sm" color="brand.500">Buy more mmFahmy NFT tokens to decrease marketplace commission <LinkIcon display="inline" /></Text>
                                </a></Link>
                            </FormControl>
